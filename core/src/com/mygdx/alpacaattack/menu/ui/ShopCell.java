...
public class ShopCell extends Actor {
    ...
    public ShopCell(ShopItem i, com.mygdx.alpacaattack.assets.MenuAssets a){
        item = i;
        assets = a;
        ...
        font = assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.shopCellFont, BitmapFont.class);
    ...
    private void createImages(){
        ...
        TextureRegion frameTexture = assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.menuAtlasPath, TextureAtlas.class).findRegion("frame");
        TextureRegion cardTexture = assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.menuAtlasPath, TextureAtlas.class).findRegion("cell");
    ...
    private void setUpCellTitle(){
        title = new Label(item.getShopName(assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.bundlePath, I18NBundle.class)), new Label.LabelStyle(font, item.getTextColor()));
    ...
    private void setUpBuyButton(){
        ...
        button.getLabel().setStyle(new Label.LabelStyle(assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.shopCellButtonFont, BitmapFont.class), Color.WHITE));
