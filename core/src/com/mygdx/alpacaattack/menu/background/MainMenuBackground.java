...
public class MainMenuBackground implements Background {
    ...
    public MainMenuBackground(com.mygdx.alpacaattack.assets.MenuAssets assets) {
        textureAtlas = assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.spriteAtlasPath, TextureAtlas.class);
        background = assets.manager.get(com.mygdx.alpacaattack.assets.MenuAssets.menuBackgroundPath, Texture.class);
